...
const command2bText = 'docker run -itd --name allinssl -p 7979:8888 -v /www/allinssl/data:/www/allinssl/data -e ALLINSSL_USER=allinssladmin -e ALLINSSL_PWD=allinsslpassword -e ALLINSSL_URL=allinsslss allinssl/allinssl:latest';
